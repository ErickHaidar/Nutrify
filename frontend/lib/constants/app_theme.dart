...
class AppThemeData {
  ...
  static const ColorScheme darkColorScheme = ColorScheme(
    primary: NutrifyTheme.accentOrange,
    primaryContainer: Color(0xFF1CDEC9),
    secondary: NutrifyTheme.darkCard,
    secondaryContainer: NutrifyTheme.lightCard,
    surface: NutrifyTheme.background,
    // White with 0.05 opacity
    error: _darkFillColor,
    onError: _darkFillColor,
    onPrimary: NutrifyTheme.background,
